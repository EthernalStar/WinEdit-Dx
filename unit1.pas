...
var
  ...
  const Changelog = 'Version 1.00: Initial Release' + LineEnding +
                    'Version 1.01: Fix Free Movement Mode for Multi Monitor Setups';  //The String used for Displaying the latest Changelog
